...
# Paste the javascript code in the location bar of your browser. 
...
This one uses "SyntaxHighlighter":http://alexgorbatchev.com/wiki/SyntaxHighlighter. It's lush, but very busy for my taste. No package linking implemented, which requires developing a trigger of some sort. 
